<div class="row-fluid sortable ui-sortable">
	<div class="box span12">
        ...
        <div class="box-content" style="display: block;">
			...
			<a class="btn btn-outline-success" href="works_sys_content7.php?id=<?php echo $id;?>">評論</a>
			<a class="btn btn-outline-success" href="works_sys_content8.php?id=<?php echo $id;?>">成員設定</a>
        </div>  
	</div>
</div>
